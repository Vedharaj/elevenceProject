...
| `SPRING_DATA_MONGODB_URI` | MongoDB Atlas / database connection URI | `mongodb+srv://<username>:<password>@cluster0.mongodb.net/elevenceProject?retryWrites=true&w=majority` |
| `SPRING_DATA_MONGODB_DATABASE` | MongoDB database name | `elevenceProject` |
